...
class Task {
  ...
  render() {
    ...
    <input id="chk-${this._id}" onclick="check(${this._id})" type="checkbox" />         
      <h6 id="task-name-${this._id}">${this._name}</h6>
      <button id="btnEdit-${this._id}" onclick="edit(${this._id})">
        <img src="./images/edit.png" width="15" alt="" />
      </button>  
      <button id="btnDelete-${this._id}" onclick="destroy(${this._id})">
